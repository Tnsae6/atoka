...
urlpatterns = [
    ...
    path('manager/order/new/', views.create_order, name='manager_create_order'),
    path('manager/order/<int:pk>/edit/', views.edit_order, name='manager_edit_order'),
    path('manager/merge/', views.merge_orders, name='manager_merge_orders'),
